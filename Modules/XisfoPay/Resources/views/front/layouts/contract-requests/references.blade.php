        ...
        <div class="card-body">
            <div class="row align-items-center mb-3">
                <div class="col text-center">
                    <h3 style="color: #1C4293" class="mb-0"><i class="fas fa-users"></i> Referencias empresariales (socios, contadores y empleados accionistas)</h3>
                ...
                <div class="modal fade" id="customerReferences" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <div class="modal-body py-0">
                                    <form action="{{ route('account.customer-references.store') }}" method="POST" class="form" 
                                        ...
                                        <div class="modal-body py-0">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 px-0">
                                                    <div class="form-group">
                                                        <label class="form-control-label" for="relationship_id">Tipo de referencia</label>
                                                        <div class="input-group input-group-merge">
                                                            <div class="input-group-prepend">
            ...
            <div class="w-100">
                <div class="table-responsive">
                    ...
                    <table class="table-striped table align-items-center table-flush table-hover text-center">
                        ...
                        <tbody class="list">
                            ...
                            <tr>
                                ...
                                <td class="text-center">{{ $customer_reference->created_at->format('M d, Y h:i a') }}</td>
                                <td class="text-center">
                                    <a data-toggle="modal" data-target="#referencemodal{{$customer_reference->id}}" href="" class="table-action table-action"
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="referencemodal{{$customer_reference->id}}" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-sm" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body py-0">
                                            <form action="{{ route('admin.customer-references.update', $customer_reference->id) }}" method="post" class="form">
                                                <div class="modal-body py-0">
                                                    @csrf
                                                    @method('PUT')
                                                    <input id="customer_id" name="customer_id" value="{{ $customer_reference->customer_id }}" hidden>
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                <label class="form-control-label" for="name">Nombre</label>
                                                                ...
                                                                <input type="text" class="form-control" name="name" id="name" placeholder="" required value="{{$customer_reference->name}}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group input-group-merge">
                                                                    ...
                                                                    <input type="text" class="form-control" name="last_name" id="last_name" placeholder="" required value="{{$customer_reference->last_name}}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group input-group-merge">
                                                                    ...
                                                                    <input type="text" class="form-control" name="phone" id="phone" placeholder="" required value="{{$customer_reference->phone}}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group input-group-merge">
                                                                    ...
                                                                    <input type="text" class="form-control" name="email" id="email" placeholder="" required value="{{$customer_reference->email}}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    <select name="relationship_id" id="relationship_id" class="form-control" required value="{{$customer_reference->relationship->relationship}}">
                                                                        @foreach($relationships as $relationship)
                                                                        <option selected="selected" value="{{ $relationship->id }}">
                                                                            {{ $relationship->relationship }}</option>
                                                                        @endforeach
                    ...
                    @else
                    <span class="text-sm"><strong>Aún no</strong> tienes referencias</span>
                    @endif
                </div>
            </div>
        </div>
