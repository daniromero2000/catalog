<div class="text-center">
    <a id="dm" data-toggle="modal" data-target="#modalConfirmPrint" class="btn btn-primary btn-sm"
        target="_blank"><i class="fa fa-print pr-2"></i>Imprimir
        contrato
    </a>
</div>
<!-- Modal -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary text-white btn-sm" target="_blank"
                    href="{{ route('account.contract.generate', $id) }}">Imprimir</a>
            </div>
        </div>
    </div>
</div>
