...
<i class="fas fa-cash-register"></i> Habilitar pago
@endsection
        ...
        <div class="col">
            ...
            <div class="card">
                <form action="{{ route($optionsRoutes .'.store') }}" method="post" class="form"
                    enctype="multipart/form-data" id="form_inputs" onsubmit="return verifyAmount()">
                    <div class="card-body">
                        @csrf
                        <div class="col pl-0 mb-3">
                            <h3 class="mb-0" style="color: #1C4393;"> <i class="fas fa-cash-register"></i> Habilitar pago</h3>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label class="form-control-label"
                                        for="contract_request_stream_account_id">Plataforma / Streaming 
                                        <span class="text-danger">*</span></label>
                                    <div class="input-group input-group-merge">
                                        <select name="contract_request_stream_account_id"
                                            id="contract_request_stream_account_id" class="form-control select" enabled
                                            required onchange="payment_type_finder()">
                                            <option disabled selected value> -- Select an option -- </option>
                                            @foreach($stream_accounts as $stream_account)
                                            <option value="{{ $stream_account->id }}">
                                                {{ $stream_account->nickname }}
                                                {{ $stream_account->streaming->streaming }}
                                            </option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label class="form-control-label" for="payment_type">Tipo de pago
                                        <span class="text-danger">*</span></label>
                                    <div class="input-group input-group-merge">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label class="form-control-label" for="usd_amount" id="input_quantity">Monto
                                        <span class="text-danger">*</span></label>
                                    <div class="input-group input-group-merge">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-dollar-sign"></i></span>
                                        </div>
                                        <input type="decimal" name="usd_amount" id="usd_amount"
                                            validation-pattern="decimal" placeholder="Ingrese la cantidad"
                                            class="form-control" value="{{ old('usd_amount') }}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <select class="form-control" name="customer_bank_account_id"
                                            ...
                                            <option value="{{$bank_account->id}}">{{$bank_account->bankNames->name}}
                                                {{$bank_account->account_type}}/
                                                {{ str_repeat("*", 4) . substr($bank_account->account_number, -4) }}
                                            </option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label class="form-control-label" for="payment_type">Comprobante<span
                                            class="text-danger">*</span> <small>Adjuntar Comprobante del
                                            Streaming</small>
                                    </label>
                    ...
                    <input type="hidden" id="loan" name="loan" value="0">
...
<div class="modal fade" id="confirm_usd_amount" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header m-auto">
            ...
            <div class="modal-body text-center" style="padding:0px !important;">
                <p>
                    No se realizan prestamos con valor inferior a $1.000 USD
                </p>
            </div>
            <div class="modal-footer">
