...
<html>
<head>
    <title>CONTRATO DE COMPRAVENTA DE TOKENS</title>
...
<body>
    ...
    <main>
            <strong><u><span style="font-size: 15px !important;">
                CONTRATO DE COMPRAVENTA DE TOKENS PERSONA NATURAL.</span></u></strong> 
        Contrato <strong>DE COMPRAVENTA DE TOKENS</strong> suscrito entre:
        ...
        @include('xisfopay::admin.print-contracts.same_contract_data_tokens')
