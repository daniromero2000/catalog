...
<div class="row mt-4">
    <div class="col-md-12 text-left">
        ...
        <br>
        <span style="font-size: .90rem; color:black;">Te informamos que tienes renovaciones de contrato <span class="btn-expired-alert">VENCIDAS</span></span>
    </div>
</div>
<br>
@endsection
    ...
    <div class="row mt-4">
        <div class="col-md-12 text-left mt-3">
            <span style="font-size: .90rem; color:black;">
                ...
                <a class="btn-redirect-dashboard" href="https://www.xisfo.com/admin/contract-renewals">Click aquí</a>
            </span>
        </div>
    </div>
</div>
