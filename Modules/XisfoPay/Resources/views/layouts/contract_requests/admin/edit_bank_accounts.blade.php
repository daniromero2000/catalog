<div class="modal fade" id="accountsmodal{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.customer-bank-accounts.update', $data->id) }}" method="post" class="form"
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <select class="form-control" name="customer_identity_id" id="customer_identity_id" required>
                                        <option value selected disabled>--Select an option--</option>
                                        @foreach ($customer->customerIdentities as $customer_identity)
                                        <option value="{{ $customer_identity->id }}" @if ($customer_identity->id ==
                                            $data->customer_identity_id) selected @endif>
