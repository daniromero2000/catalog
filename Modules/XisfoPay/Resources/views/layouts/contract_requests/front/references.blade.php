<div class="card">
    <div class="card-body">
        <div class="row align-items-center mb-3">
            <div class="col">
                <h3 style="color: #1C4293" class="mb-0"> <i class="fas fa-map-pin"></i> Referencias o contactos</h3>
            </div>
        ...
        <div class="w-100">
            <div class="table-responsive">
                        ...
                        <div class="modal fade" id="referencemodal{{$customer_reference->id}}" tabindex="-1"
                            ...
                            <div class="modal-dialog modal-sm" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body py-0">
                                        <form
                                            action="{{ route('account.customer-references.update', $customer_reference->id) }}"
                ...
                @else
                <span class="text-sm"><strong>Aún no</strong> tienes referencias agregadas</span>
                @endif
            </div>
        </div>
    </div>
