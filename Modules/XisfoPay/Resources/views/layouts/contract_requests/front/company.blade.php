<div class="card">
    <div class="card-body">
        <div class="row align-items-center mb-3">
            <div class="col">
                <h3 class="mb-0" style="color: #1c4393 !important;"> <i class="fas fa-university"></i> Información legal y datos de empresa</h3>
            </div>
        </div>
        <div class="w-100">
                ...
                <table class="table-striped table align-items-center table-flush table-hover text-center">
                    ...
                    <tbody class="list">
                        <tr>
                            ...
                            @include('xisfopay::layouts.contract_requests.front.edit_company', ['data' => $customer_company])
                            @include('xisfopay::layouts.contract_requests.front.company_image')
                        </tr>
                    </tbody>
                </table>
            </div>
