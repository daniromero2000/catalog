<div class="modal fade" id="modal-bankImage{{$data->id}}" tabindex="-1" role="dialog"
    aria-labelledby="modal-default" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title" id="modal-title-default">Documento De Renovación De Contrato</h6>
            ...
            <div class="modal-body">
                <span>No hay un documento de renovación de contrato</span>
            </div>
            @endif
