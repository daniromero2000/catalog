<div class="modal fade" id="commentmodal" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.payment-request-commentaries.store') }}" method="post" class="form"
                enctype="multipart/form-data" onsubmit="disable_button('create_button_add_comment_modal')">
                <div class="modal-body py-0">
                    @csrf
                    <input name="payment_request_id" id="payment_request_id" type="hidden" value="{{ $id }}">
                ...
                <div class="w-100 p-3 text-right">
                    <button type="submit" class="btn btn-primary" id="create_button_add_comment_modal">Agregar</button>
