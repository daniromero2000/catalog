<div class="card">
    <div class="card-header">
        <div class="row align-items-center mb-3">
            <div class="col">
                <h3 class="mb-0"><strong>Préstamo / Pago de tokens</strong>
                    <span class="badge"
            ...
            @endif
            @if (auth()->guard('employee')->user()->hasRole('superadmin|admin|financial') && $payment_request_advance->is_aprobed != 1)
            <div class="col text-right">
                <a data-toggle="modal" data-target="#modal{{ $payment_request_advance->id }}"
                    ...
                    <tbody class="list">
                        <tr>
                            ...
                            <td class="text-center">@include('generals::layouts.status', ['status' =>
                                $payment_request_advance->is_aprobed]) @include('generals::layouts.status', ['status' =>
