...
class SendFortnightsPaymentDatesNotifications implements ShouldQueue
{
    ...
    public function handle(ContractRequestStreamAccountUseCaseInterface $contractRequestStreamAccountUseCaseInterface)
    {
        ...
        $this->contractRequestStreamAccountServiceInterface->sendPaymentDatesNotifications([1,15]);
    }
}
