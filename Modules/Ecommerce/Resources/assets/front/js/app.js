...
jQuery(document).ready(function ($) {
    var html = '<a data-toggle="dropdown" href="#" aria-expanded="false"> <div> <div id="wishlistContainer"> <div class="relative position-cart"> <i class="fas fa-heart text-white m-auto"></i> <div class="item" id="itemsWishlist" style="display: none"> <span class="badge navbar-badge badge-count" id="totalWishlist">0</span> <div class="circle" style="animation-delay: -3s"></div> <div class="circle" style="animation-delay: -2s"></div> <div class="circle" style="animation-delay: -1s"></div> <div class="circle" style="animation-delay: 0s"> </div> </div> </div> </div> </div> </a> <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" style="left: inherit; right: 0px;" id="wishlistItems"> </div>'
