<form action="{{ route('creditcard.store') }}" onsubmit="test()" method="POST">
    @csrf
    <div class="row py-4">
        <div class="col-12">
            <div class="form-group">
                ...
                <input type="text" required name="CREDIT_CARD_NUMBER" class="form-control"
                    placeholder="XXXX XXXX XXXX XXXX" id="creditcard" aria-describedby="textHelp" minlength="13">
            </div>
            ...
            <div class="row mt-4">
                <div class="col-12">
                    <button type="submit" onclick="test()" class="btn btn-primary btn-block btn-submit">Pagar</button>
                </div>
            </div>
        </div>
    </div>
