...
<div class="d-flex justify-content-center">
    ...
    @endforeach
    @endif
    <a href="#" data-toggle="modal" data-target="#commentmodal{{ $data->id }}" class=" table-action table-action"
        data-toggle="tooltip" data-original-title="Agregar Comentario"><i class="fa fa-comment"></i>
    </a>
</div>
<script>
    function destroy(id) {
