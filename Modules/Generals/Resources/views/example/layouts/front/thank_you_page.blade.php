    ...
    <section>
        <div class="w-100 font">
            <div class="container-reset row content-header">
                <a href="/" class="w-100" style=" z-index: 99999; "><img class="img-logo"
                        src="{{asset('img/FVN/logo.png')}}" alt="feels-very-nice"></a>
            ...
            <div class="container-reset text-center">
                <a class="btn btn-primary mx-auto" style=" background-color: #ba3d6b; border-color: #bd396a; "
                    href="/">Ver mas productos</a>
            </div>
            <div class="container-reset mt-md-4">
                <img class="img-fluid lazy" src="{{asset('img/FVN/banner03.jpg')}}" alt="feels-very-nice">
