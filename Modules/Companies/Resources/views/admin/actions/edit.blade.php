...
<section class="content">
    ...
    <div class="box crud-box" style="box-shadow: 0px 2px 25px rgba(0, 0, 0, .25);">
        <form action="{{ route('admin.permissions.store') }}" method="post" class="form" onsubmit="disable_button('create_button_')">
            <div class="box-body">
                @csrf
                <h1>Crear Módulo</h1>
            ...
            <div class="box-footer">
                <div class="btn-group">
                    <div class="btn-group">
                        ...
                        <button type="submit" class="btn btn-primary" id="create_button_">Crear</button>
                    </div>
                </div>
            </div>
        </form>
