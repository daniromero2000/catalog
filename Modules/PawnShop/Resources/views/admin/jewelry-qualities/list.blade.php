        ...
        <div class="table-responsive">
            <table class="table-striped table align-items-center table-flush table-hover">
                ...
                <tbody class="list">
                    ...
                    @include('pawnshop::layouts.jewelry-qualities.edit_jewelry_quality')
                    @endforeach
                </tbody>
            </table>
        </div>
        <div class="card-footer py-2 text-center">
            {{ $jewelry_qualities->appends(request()->query())->links() }}
        </div>
    </div>
    </div>
    @else
