                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="number" name="charge" id="charge" validation-pattern="value"
                                        placeholder="Valor" class="form-control" value="{{ $data->charge }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="description" id="description" rows="5"
                                            placeholder="Descripción">{{ $data->description }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
