        ...
        <div class="card-header border-0">
            <div class="row">
                ...
                <div class="col-8 col-sm-6 col-md-6 col-xl-9">
                    @include('generals::layouts.searchMonth', ['route' => route($optionsRoutes.'.trimester')])
                </div>
            </div>
        </div>
        @if($firstMonthLiquidations->isNotEmpty() || $secondMonthLiquidations->isNotEmpty() || $thirdMonthLiquidations->isNotEmpty())
        <div class="card px-3">
            <div class="row">
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" style="background: none;" id="report_tables" role="tabpanel"
                    ...
                    @include('camstudio::admin.layouts.camstudio-reports.trimester.report_tables')
                </div>
                <div class="tab-pane fade" style="background: none;" id="report_graphs" role="tabpanel"
                    aria-labelledby="streaming-tab">
                    @include('camstudio::admin.layouts.camstudio-reports.trimester.report_graphs')
                </div>
...
@include('camstudio::admin.layouts.camstudio-report-commentaries.add_comment_modal', ['periodType' => 'trimester'])
<script>
    var today = new Date();
